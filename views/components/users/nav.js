...
const crearNavHome = ()=>{nav.innerHTML = `
    <div class="h-16 mx-auto flex items-center px-4 justify-between">
        ...
        <a href="/dashboard/users" class="text-neutral-50 font-bold font-mono text-2xl italic">Boss Transport</a>
...
const crearMenuLat = ()=>{menuLateral.innerHTML = `
    <div class="fixed p-4 self-start w-44 text-lg max-md:hidden border-slate-300/10 border-r-2 bg-gradient-to-br from-cyan-950 to-black/95 min-h-screen">
        <div class="hover:bg-cyan-800 rounded-md transition duration-150 ease-in-out my-4">
            <a href="/dashboard/users/vehiculos/" class="font-mono font-bold text-white px-1 py-1 uppercase">Vehiculos</a>
        </div>
        <div class="hover:bg-cyan-800 rounded-md transition duration-150 ease-in-out my-4">
            <a href="/dashboard/users/rutas/" class="font-mono font-bold text-white px-1 py-1 uppercase">Rutas</a>
        </div>
        <div class="hover:bg-cyan-800 rounded-md transition duration-150 ease-in-out">
            <a href="/dashboard/users/mantenimiento/" class="font-mono font-bold text-white px-1 py-1 uppercase">Mantenimiento</a>
        </div>        
     </div>
    `
}
...
const crearMenuModal2 = ()=>{menuModal2.innerHTML = `
    <ul class="fixed top-16 bg-gradient-to-br from-cyan-950 to-black/95 rounded-lg">
        <li class="my-4 hover:bg-cyan-800 rounded-md transition duration-150 ease-in-out mb-2 mx-4"><a href="/dashboard/users/password/" class="font-mono font-bold text-white px-1 py-1 uppercase">Contraseña</a></li>
...
if(window.location.pathname === '/dashboard/users/'){
    ...
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/vehiculos/'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/vehiculos/nuevo.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/vehiculos/editar.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/usuarios/'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/usuarios/nuevo.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/usuarios/editar.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/rutas/'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/rutas/nuevo.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/rutas/editar.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/rutas/ver.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/rutas/finalizar.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/mantenimiento/'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/mantenimiento/nuevo.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/mantenimiento/ver.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/mantenimiento/editar.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/mantenimiento/finalizar.html'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
}else if(window.location.pathname === '/dashboard/users/password/'){
    crearNavHome(),
    crearMenuLat(),
    crearMenuModal(),
    crearMenuModal2()
